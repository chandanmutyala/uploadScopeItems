		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload Scope Items",
									"targetURL": "#uploadexcellsheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uploadexcellsheet-display": {
								"semanticObject": "uploadexcellsheet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uploadexcellsheet",
									"url": sap.ui.require.toUrl("uploadexcellsheet")
								}
							}
						}
					}
